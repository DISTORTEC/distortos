...
DO_INCLUDE := 1
SIMPLE_TARGETS := clean configure distclean menuconfig help
...
menuconfig .. to configure distortos
configure  .. to execute configure.sh; use "make configure [CONFIG_PATH=<path>]"
                <path> .. the path where distortosConfiguration.mk can be found; default "./"
distclean  .. remove the build output, doxygen documentation and file created by configure.sh
