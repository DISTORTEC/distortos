...
public:
	...
	{
		/// signal generated by ThreadBase::generateSignal() or ThisThread::Signals::generateSignal() (similar to
		/// \a SI_USER)
		Generated,
		/// signal queued by ThreadBase::queueSignal() or ThisThread::Signals::queueSignal() (similar to \a SI_QUEUE)
		Queued,
	};
