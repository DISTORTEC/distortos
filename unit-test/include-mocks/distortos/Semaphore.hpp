...
#ifndef UNIT_TEST_INCLUDE_MOCKS_DISTORTOS_SEMAPHORE_HPP_
#define UNIT_TEST_INCLUDE_MOCKS_DISTORTOS_SEMAPHORE_HPP_
...
#endif	// UNIT_TEST_INCLUDE_MOCKS_DISTORTOS_SEMAPHORE_HPP_
