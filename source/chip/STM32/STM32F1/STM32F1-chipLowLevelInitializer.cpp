...
void chipLowLevelInitializer()
{
	...
	RCC->APB2ENR |=
#if defined(CONFIG_CHIP_STM32_GPIO_V1_GPIOA_ENABLE)
			RCC_APB2ENR_IOPAEN |
#endif	// def CONFIG_CHIP_STM32_GPIO_V1_GPIOA_ENABLE
#if defined(CONFIG_CHIP_STM32_GPIO_V1_GPIOB_ENABLE)
			RCC_APB2ENR_IOPBEN |
#endif	// def CONFIG_CHIP_STM32_GPIO_V1_GPIOB_ENABLE
#if defined(CONFIG_CHIP_STM32_GPIO_V1_GPIOC_ENABLE)
			RCC_APB2ENR_IOPCEN |
#endif	// def CONFIG_CHIP_STM32_GPIO_V1_GPIOC_ENABLE
#if defined(CONFIG_CHIP_STM32_GPIO_V1_GPIOD_ENABLE)
			RCC_APB2ENR_IOPDEN |
#endif	// def CONFIG_CHIP_STM32_GPIO_V1_GPIOD_ENABLE
#if defined(CONFIG_CHIP_STM32_GPIO_V1_GPIOE_ENABLE)
			RCC_APB2ENR_IOPEEN |
#endif	// def CONFIG_CHIP_STM32_GPIO_V1_GPIOE_ENABLE
#if defined(CONFIG_CHIP_STM32_GPIO_V1_GPIOF_ENABLE)
			RCC_APB2ENR_IOPFEN |
#endif	// def CONFIG_CHIP_STM32_GPIO_V1_GPIOF_ENABLE
#if defined(CONFIG_CHIP_STM32_GPIO_V1_GPIOG_ENABLE)
			RCC_APB2ENR_IOPGEN |
#endif	// def CONFIG_CHIP_STM32_GPIO_V1_GPIOG_ENABLE
			0;
}
