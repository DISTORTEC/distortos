...
#if defined(DISTORTOS_CHIP_STM32F1_RCC_HSE_ENABLE) && \
...
constexpr uint32_t pll23InFrequency {DISTORTOS_CHIP_STM32F1_RCC_HSE_FREQUENCY / DISTORTOS_CHIP_STM32F1_RCC_PREDIV2};
...
constexpr uint32_t pll2OutFrequency {pll23InFrequency * DISTORTOS_CHIP_STM32F1_RCC_PLL2MUL};
...
constexpr uint32_t pll3OutFrequency {pll23InFrequency * DISTORTOS_CHIP_STM32F1_RCC_PLL3MUL};
...
#endif	// defined(DISTORTOS_CHIP_STM32F1_RCC_HSE_ENABLE) &&
		// (defined(DISTORTOS_CHIP_STM32F105) || defined(DISTORTOS_CHIP_STM32F107)) &&
		// defined(DISTORTOS_CHIP_STM32F1_RCC_PREDIV2_PLL2_PLL3_ENABLE)
...
constexpr uint32_t prediv1InFrequency {DISTORTOS_CHIP_STM32F1_RCC_HSE_FREQUENCY};
...
constexpr uint32_t prediv1OutFrequency {prediv1InFrequency / DISTORTOS_CHIP_STM32F1_RCC_PREDIV1};
...
constexpr uint32_t sysclkFrequency {DISTORTOS_CHIP_STM32F1_RCC_HSE_FREQUENCY};
...
#else	// !def DISTORTOS_CHIP_STM32F1_STANDARD_CLOCK_CONFIGURATION_ENABLE

/// SYSCLK frequency, Hz
constexpr uint32_t sysclkFrequency {DISTORTOS_CHIP_STM32F1_RCC_SYSCLK_FREQUENCY};

#endif	// !def DISTORTOS_CHIP_STM32F1_STANDARD_CLOCK_CONFIGURATION_ENABLE

/// AHB frequency, Hz
constexpr uint32_t ahbFrequency {sysclkFrequency / DISTORTOS_CHIP_STM32F1_RCC_HPRE};

/// APB1 frequency, Hz
constexpr uint32_t apb1Frequency {ahbFrequency / DISTORTOS_CHIP_STM32F1_RCC_PPRE1};

static_assert(apb1Frequency <= maxApb1Frequency, "Invalid APB1 (low speed) frequency!");

/// APB2 frequency, Hz
constexpr uint32_t apb2Frequency {ahbFrequency / DISTORTOS_CHIP_STM32F1_RCC_PPRE2};
