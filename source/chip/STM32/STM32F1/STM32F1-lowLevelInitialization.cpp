...
#ifdef CONFIG_CHIP_STM32F1_RCC_STANDARD_CLOCK_CONFIGURATION_ENABLE
...
#else	// !def CONFIG_CHIP_STM32F1_RCC_STANDARD_CLOCK_CONFIGURATION_ENABLE

	constexpr uint32_t ahbFrequency {CONFIG_CHIP_STM32F1_RCC_AHB_FREQUENCY};

#endif	// !def CONFIG_CHIP_STM32F1_RCC_STANDARD_CLOCK_CONFIGURATION_ENABLE
