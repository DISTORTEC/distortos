...
{
#ifdef DISTORTOS_CHIP_STM32L0_FLASH_PREFETCH_ENABLE
	configurePrefetchBuffer(true);
#else	// !def DISTORTOS_CHIP_STM32L0_FLASH_PREFETCH_ENABLE
	configurePrefetchBuffer(false);
#endif	// !def DISTORTOS_CHIP_STM32L0_FLASH_PREFETCH_ENABLE

#ifdef DISTORTOS_CHIP_STM32L0_STANDARD_CLOCK_CONFIGURATION_ENABLE

	RCC->APB1ENR |= RCC_APB1ENR_PWREN;

	configureVoltageScaling(DISTORTOS_CHIP_STM32L0_PWR_VOLTAGE_SCALE_MODE);

#ifdef DISTORTOS_CHIP_STM32L0_RCC_MSI_ENABLE
	enableMsi(DISTORTOS_CHIP_STM32L0_RCC_MSIRANGE);
#endif

#ifdef DISTORTOS_CHIP_STM32L0_RCC_HSE_ENABLE

#ifdef DISTORTOS_CHIP_STM32L0_RCC_HSE_CLOCK_BYPASS
	enableHse(true);
#else	// !def DISTORTOS_CHIP_STM32L0_RCC_HSE_CLOCK_BYPASS
	enableHse(false);
#endif	// !def DISTORTOS_CHIP_STM32L0_RCC_HSE_CLOCK_BYPASS

#endif	// def DISTORTOS_CHIP_STM32L0_RCC_HSE_ENABLE

#ifdef DISTORTOS_CHIP_STM32L0_RCC_HSI16_ENABLE
	enableHsi16();
#endif	// def DISTORTOS_CHIP_STM32L0_RCC_HSI16_ENABLE

#ifdef DISTORTOS_CHIP_STM32L0_RCC_HSI48_ENABLE
	enableHsi48();
#endif	// def DISTORTOS_CHIP_STM32L0_RCC_HSI48_ENABLE
	...
	enablePll(DISTORTOS_CHIP_STM32L0_RCC_PLLMUL, DISTORTOS_CHIP_STM32L0_RCC_PLLDIV);

#endif	// def DISTORTOS_CHIP_STM32L0_RCC_PLL_ENABLE

	configureAhbClockDivider(DISTORTOS_CHIP_STM32L0_RCC_HPRE);
	configureApbClockDivider(false, DISTORTOS_CHIP_STM32L0_RCC_PPRE1);
	configureApbClockDivider(true, DISTORTOS_CHIP_STM32L0_RCC_PPRE2);

#if DISTORTOS_CHIP_STM32L0_PWR_VOLTAGE_SCALE_MODE == 3
	constexpr uint32_t frequencyThreshold {4200000};
#elif DISTORTOS_CHIP_STM32L0_PWR_VOLTAGE_SCALE_MODE == 2
