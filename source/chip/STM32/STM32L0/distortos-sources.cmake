...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32L0_STANDARD_CLOCK_CONFIGURATION_ENABLE)
...
if(distortos_Clocks_00_Standard_configuration_of_clocks)
	...
	distortosSetConfiguration(INTEGER
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32L0_PWR_VOLTAGE_SCALE_MODE)

	distortosSetConfiguration(BOOLEAN
			distortos_Clocks_02_MSI
			OFF
			HELP "Enable MSI."
			OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_MSI_ENABLE)
	...
	if(distortos_Clocks_02_MSI)
		...
		distortosSetConfiguration(INTEGER
				...
				OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_MSIRANGE)

	endif(distortos_Clocks_02_MSI)

	if(DISTORTOS_CHIP_STM32L0_RCC_HSE_FREQUENCY)

		if(DISTORTOS_CHIP_STM32L0_RCC_HSE_CLOCK_BYPASS)
			set(help "Enable HSE external user clock, ${DISTORTOS_CHIP_STM32L0_RCC_HSE_FREQUENCY} Hz.")
		else()
			set(help "Enable HSE crystal/ceramic resonator, ${DISTORTOS_CHIP_STM32L0_RCC_HSE_FREQUENCY} Hz.")
		endif()
		...
		distortosSetConfiguration(BOOLEAN
				...
				OFF
				HELP ${help}
				OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_HSE_ENABLE)

	endif(DISTORTOS_CHIP_STM32L0_RCC_HSE_FREQUENCY)

	distortosSetConfiguration(BOOLEAN
			distortos_Clocks_05_HSI16
			ON
			HELP "Enable HSI16."
			OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_HSI16_ENABLE)

	if(DISTORTOS_CHIP MATCHES "STM32L0[5-8][23]")

		distortosSetConfiguration(BOOLEAN
				distortos_Clocks_05_HSI48
				OFF
				HELP "Enable HSI48."
				OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_HSI48_ENABLE)

	endif(DISTORTOS_CHIP MATCHES "STM32L0[5-8][23]")
	...
	if(distortos_Clocks_04_HSE OR distortos_Clocks_05_HSI16)
		...
		distortosSetConfiguration(BOOLEAN
				...
				ON
				HELP "Enable PLL."
				OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_PLL_ENABLE)
		...
		if(distortos_Clocks_06_PLL)
			...
			distortosSetConfiguration(STRING
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_PLLSRC
			...
			distortosSetConfiguration(STRING
					...
					VCOout = PLLin * PLLMUL"
					OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_PLLMUL
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_PLLDIV)
	...
	distortosSetConfiguration(STRING
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_SYSCLK
			OUTPUT_TYPES BOOLEAN)
	...
	distortosSetConfiguration(INTEGER
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_SYSCLK_FREQUENCY)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_HPRE
		OUTPUT_TYPES INTEGER)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_PPRE1
		OUTPUT_TYPES INTEGER)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32L0_RCC_PPRE2
		OUTPUT_TYPES INTEGER)
...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32L0_FLASH_PREFETCH_ENABLE)
