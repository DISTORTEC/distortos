...
/**
 * \brief ChipOutputPin class is a single output pin of GPIOv2 in STM32.
 *
 * \ingroup devices
 */
...
public:
	...
	explicit ChipOutputPin(Pin pin, bool openDrain = {}, PinOutputSpeed outputSpeed = {}, PinPull pull = {},
