...
#if defined(DISTORTOS_CHIP_STM32_USARTV2_HAS_CR1_M1_BIT) && !defined(USART_CR1_M1_Pos)
#define USART_CR1_M1_Pos					__builtin_ctzl(USART_CR1_M1)
#endif	// defined(DISTORTOS_CHIP_STM32_USARTV2_HAS_CR1_M1_BIT) && !defined(USART_CR1_M1_Pos)
...
#ifdef DISTORTOS_CHIP_STM32_USARTV2_HAS_CR1_M1_BIT
				(cr1 & USART_CR1_M1) != 0 ? 7 :
#endif	// def DISTORTOS_CHIP_STM32_USARTV2_HAS_CR1_M1_BIT
