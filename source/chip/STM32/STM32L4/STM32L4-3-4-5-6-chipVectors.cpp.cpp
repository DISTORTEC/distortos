/**
 * \file
 * \brief STM32L4[3-6] chip vector table and default weak handlers
 *
...
// 0x0b8, 30: Reserved
__attribute__ ((weak)) void Reserved_0x0b8_Handler()
{
	while (1);
}
...
// 0x0e8, 42: Reserved
__attribute__ ((weak)) void Reserved_0x0e8_Handler()
{
	while (1);
}

// 0x0ec, 43: Reserved
__attribute__ ((weak)) void Reserved_0x0ec_Handler()
{
	while (1);
}

// 0x0f0, 44: Reserved
__attribute__ ((weak)) void Reserved_0x0f0_Handler()
{
	while (1);
}

// 0x0f4, 45: Reserved
__attribute__ ((weak)) void Reserved_0x0f4_Handler()
{
	while (1);
}

// 0x0f8, 46: Reserved
__attribute__ ((weak)) void Reserved_0x0f8_Handler()
{
	while (1);
}

// 0x0fc, 47: Reserved
__attribute__ ((weak)) void Reserved_0x0fc_Handler()
{
	while (1);
}
...
// 0x108, 50: Reserved
__attribute__ ((weak)) void Reserved_0x108_Handler()
{
	while (1);
}
...
// 0x14c, 67: USB Event through EXTI line 17
...
// 0x18c, 83: I2C4 Event, wakeup through EXTI line 40
...
extern "C" const InterruptVector chipVectors[] __attribute__ ((section(".chipVectors"), used))
{
		...
		Reserved_0x0b8_Handler,				// 0x0b8, 30: Reserved
		...
		Reserved_0x0e8_Handler,				// 0x0e8, 42: Reserved
		Reserved_0x0ec_Handler,				// 0x0ec, 43: Reserved
		Reserved_0x0f0_Handler,				// 0x0f0, 44: Reserved
		Reserved_0x0f4_Handler,				// 0x0f4, 45: Reserved
		Reserved_0x0f8_Handler,				// 0x0f8, 46: Reserved
		Reserved_0x0fc_Handler,				// 0x0fc, 47: Reserved
		Reserved_0x100_Handler,				// 0x100, 48: Reserved
		SDMMC1_IRQHandler,					// 0x104, 49: SDMMC1
		Reserved_0x108_Handler,				// 0x108, 50: Reserved
		...
		USB_IRQHandler,						// 0x14c, 67: USB Event through EXTI line 17
		...
		CRS_IRQHandler,						// 0x188, 82: CRS
		I2C4_EV_IRQHandler,					// 0x18c, 83: I2C4 Event, wakeup through EXTI line 40
		I2C4_ER_IRQHandler,					// 0x190, 84: I2C4 Error
};

static_assert(sizeof(chipVectors) / sizeof(*chipVectors) == 85, "Invalid size of chipVectors[]!");
