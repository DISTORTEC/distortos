/**
 * \file
 * \brief STM32L471 chip vector table and default weak handlers
 *
...
#if defined(CONFIG_CHIP_STM32L471)
...
// 0x118, 54: TIM6 and DAC12 Underrun
...
extern "C" const InterruptVector chipVectors[] __attribute__ ((section(".chipVectors"), used))
{
		...
		TIM6_DAC_IRQHandler,				// 0x118, 54: TIM6 and DAC12 Underrun
...
static_assert(sizeof(chipVectors) / sizeof(*chipVectors) == 82, "Invalid size of chipVectors[]!");

#endif	// defined(CONFIG_CHIP_STM32L471)
