...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F0_STANDARD_CLOCK_CONFIGURATION_ENABLE)

if(distortos_Clocks_00_Standard_configuration_of_clocks)

	if(DISTORTOS_CHIP_STM32F0_RCC_HSE_FREQUENCY)

		if(DISTORTOS_CHIP_STM32F0_RCC_HSE_CLOCK_BYPASS)
			set(help "Enable HSE external user clock, ${DISTORTOS_CHIP_STM32F0_RCC_HSE_FREQUENCY} Hz.")
		else()
			set(help "Enable HSE crystal/ceramic resonator, ${DISTORTOS_CHIP_STM32F0_RCC_HSE_FREQUENCY} Hz.")
		endif()
		...
		distortosSetConfiguration(BOOLEAN
				...
				OFF
				HELP ${help}
				OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_HSE_ENABLE)

	endif(DISTORTOS_CHIP_STM32F0_RCC_HSE_FREQUENCY)
	...
	if(DISTORTOS_CHIP MATCHES "STM32F0[49]|STM32F07[128]")
		...
		distortosSetConfiguration(BOOLEAN
				...
				OFF
				HELP "Enable HSI48."
				OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_HSI48_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			ON
			HELP "Enable PLL."
			OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_PLL_ENABLE)
	...
	if(distortos_Clocks_03_PLL)
		...
		distortosSetConfiguration(STRING
				...
				OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_PLLSRC
		...
		if(distortos_Clocks_04_Clock_source_of_PLL MATCHES "PREDIV")
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_PREDIV)
		...
		distortosSetConfiguration(INTEGER
				...
				PLLout = PLLin * PLLMUL"
				OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_PLLMUL)
	...
	distortosSetConfiguration(STRING
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_SYSCLK
			OUTPUT_TYPES BOOLEAN)
	...
	distortosSetConfiguration(INTEGER
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_SYSCLK_FREQUENCY)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_HPRE
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F0_RCC_PPRE
		OUTPUT_TYPES INTEGER)
...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F0_FLASH_PREFETCH_ENABLE)
