...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F7_STANDARD_CLOCK_CONFIGURATION_ENABLE)
...
if(distortos_Clocks_00_Standard_configuration_of_clocks)
	...
	distortosSetConfiguration(INTEGER
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32F7_PWR_VOLTAGE_SCALE_MODE)

	if(distortos_Clocks_01_Voltage_scale_mode LESS_EQUAL 2 AND DISTORTOS_CHIP_STM32F7_VDD_MV GREATER_EQUAL 2100)

		distortosSetConfiguration(BOOLEAN
				distortos_Clocks_02_Over_drive_mode
				OFF
				HELP "Enable over-drive mode."
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_PWR_OVER_DRIVE_ENABLE)

	endif(distortos_Clocks_01_Voltage_scale_mode LESS_EQUAL 2 AND DISTORTOS_CHIP_STM32F7_VDD_MV GREATER_EQUAL 2100)

	if(DISTORTOS_CHIP_STM32F7_RCC_HSE_FREQUENCY)

		if(DISTORTOS_CHIP_STM32F7_RCC_HSE_CLOCK_BYPASS)
			set(help "Enable HSE external user clock, ${DISTORTOS_CHIP_STM32F7_RCC_HSE_FREQUENCY} Hz.")
		else()
			set(help "Enable HSE crystal/ceramic resonator, ${DISTORTOS_CHIP_STM32F7_RCC_HSE_FREQUENCY} Hz.")
		endif()
		...
		distortosSetConfiguration(BOOLEAN
				...
				OFF
				HELP ${help}
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_HSE_ENABLE)

	endif(DISTORTOS_CHIP_STM32F7_RCC_HSE_FREQUENCY)

	distortosSetConfiguration(BOOLEAN
			distortos_Clocks_04_PLLs
			ON
			HELP "Enable PLLs."
			OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLS_ENABLE)
	...
	if(distortos_Clocks_04_PLLs)
		...
		distortosSetConfiguration(STRING
				...
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLSRC
		...
		distortosSetConfiguration(INTEGER
				...
				VCOin = PLLin / PLLM"
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLM)

		distortosSetConfiguration(BOOLEAN
				distortos_Clocks_07_PLL
				ON
				HELP "Enable main PLL."
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLL_ENABLE)
		...
		if(distortos_Clocks_07_PLL)
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLN)
			...
			distortosSetConfiguration(STRING
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLP
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLQ)

			if(DISTORTOS_CHIP MATCHES "STM32F7[67]")
				...
				distortosSetConfiguration(INTEGER
						...
						OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLR)

			endif(DISTORTOS_CHIP MATCHES "STM32F7[67]")
		...
		distortosSetConfiguration(BOOLEAN
				...
				OFF
				HELP "Enable PLLI2S."
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLI2S_ENABLE)
		...
		if(distortos_Clocks_12_PLLI2S)
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLI2SN)

			if(NOT DISTORTOS_CHIP MATCHES "STM32F7[23]")
				...
				distortosSetConfiguration(STRING
						...
						OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLI2SP
						OUTPUT_TYPES INTEGER)

			endif(NOT DISTORTOS_CHIP MATCHES "STM32F7[23]")
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLI2SQ)
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLI2SR)
		...
		distortosSetConfiguration(BOOLEAN
				...
				OFF
				HELP "Enable PLLSAI."
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLSAI_ENABLE)
		...
		if(distortos_Clocks_17_PLLSAI)
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLSAIN)
			...
			distortosSetConfiguration(STRING
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLSAIP
					OUTPUT_TYPES INTEGER)
			...
			distortosSetConfiguration(INTEGER
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLSAIQ)
			...
			if(NOT DISTORTOS_CHIP MATCHES "STM32F7[23]")
				...
				distortosSetConfiguration(INTEGER
						...
						OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLLSAIR)
		...
		if(distortos_Clocks_07_PLL OR distortos_Clocks_17_PLLSAI)
			...
			distortosSetConfiguration(STRING
					...
					OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLL48CLK
					OUTPUT_TYPES BOOLEAN)
	...
	distortosSetConfiguration(STRING
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_SYSCLK
			OUTPUT_TYPES BOOLEAN)
	...
	distortosSetConfiguration(INTEGER
			...
			- 180 MHz (with over-drive mode) or 168 MHz (otherwise) in voltage scale 2 mode,
			- 144 MHz in voltage scale 3 mode."
			OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_SYSCLK_FREQUENCY)
	...
	distortosSetConfiguration(INTEGER
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PLL48CLK_FREQUENCY)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_HPRE
		OUTPUT_TYPES INTEGER)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PPRE1
		OUTPUT_TYPES INTEGER)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_PPRE2
		OUTPUT_TYPES INTEGER)
...
if(distortos_Clocks_00_Standard_configuration_of_clocks)
	...
	distortosSetConfiguration(STRING
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_SDMMC1CLK
			OUTPUT_TYPES BOOLEAN)

	if(DISTORTOS_CHIP MATCHES "STM32F7[2367]")
		...
		distortosSetConfiguration(STRING
				...
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_SDMMC2CLK
				OUTPUT_TYPES BOOLEAN)

	endif(DISTORTOS_CHIP MATCHES "STM32F7[2367]")
	...
	distortosSetConfiguration(INTEGER
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_SDMMC1CLK_FREQUENCY)
	...
	if(DISTORTOS_CHIP MATCHES "STM32F7[2367]")
		...
		distortosSetConfiguration(INTEGER
				...
				OUTPUT_NAME DISTORTOS_CHIP_STM32F7_RCC_SDMMC2CLK_FREQUENCY)
...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32F7_FLASH_PREFETCH_ENABLE)

distortosSetConfiguration(BOOLEAN
		distortos_Memory_01_Flash_ART_accelerator
		ON
		HELP "Enable flash ART accelerator in FLASH->ACR register."
		OUTPUT_NAME DISTORTOS_CHIP_STM32F7_FLASH_ART_ACCELERATOR_ENABLE)
