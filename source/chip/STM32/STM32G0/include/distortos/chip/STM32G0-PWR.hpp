/**
 * \file
 * \brief Header for PWR-related functions for STM32G0
 *
...
#ifndef SOURCE_CHIP_STM32_STM32G0_INCLUDE_DISTORTOS_CHIP_STM32G0_PWR_HPP_
#define SOURCE_CHIP_STM32_STM32G0_INCLUDE_DISTORTOS_CHIP_STM32G0_PWR_HPP_
...
/**
 * \brief Disables write protection of RTC domain (RTC registers and backup registers).
 */

void disableRtcDomainWriteProtection();

/**
 * \brief Enables write protection of RTC domain (RTC registers and backup registers).
 */
...
#endif	// SOURCE_CHIP_STM32_STM32G0_INCLUDE_DISTORTOS_CHIP_STM32G0_PWR_HPP_
