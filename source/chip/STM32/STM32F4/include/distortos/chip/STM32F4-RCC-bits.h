...
#ifndef SOURCE_CHIP_STM32_STM32F4_INCLUDE_DISTORTOS_CHIP_STM32F4_RCC_BITS_H_
#define SOURCE_CHIP_STM32_STM32F4_INCLUDE_DISTORTOS_CHIP_STM32F4_RCC_BITS_H_
...
#define RCC_APB1RSTR_CAN3RST_bit			27
...
#define RCC_APB1RSTR_CAN3RST_bb				BITBAND(&RCC->APB1RSTR, RCC_APB1RSTR_CAN3RST_bit)
...
#define RCC_APB2RSTR_DFSDM2RST_bit			25
#define RCC_APB2RSTR_DFSDM1RST_bit			24
...
#define RCC_APB2RSTR_UART10RST_bit			7
#define RCC_APB2RSTR_UART9RST_bit			6
...
#define RCC_APB2RSTR_DFSDM2RST_bb			BITBAND(&RCC->APB2RSTR, RCC_APB2RSTR_DFSDM2RST_bit)
#define RCC_APB2RSTR_DFSDM1RST_bb			BITBAND(&RCC->APB2RSTR, RCC_APB2RSTR_DFSDM1RST_bit)
...
#define RCC_APB2RSTR_UART10RST_bb			BITBAND(&RCC->APB2RSTR, RCC_APB2RSTR_UART10RST_bit)
#define RCC_APB2RSTR_UART9RST_bb			BITBAND(&RCC->APB2RSTR, RCC_APB2RSTR_UART9RST_bit)
...
#define RCC_APB1ENR_CAN3EN_bit				27
...
#define RCC_APB1ENR_CAN3EN_bb				BITBAND(&RCC->APB1ENR, RCC_APB1ENR_CAN3EN_bit)
...
#define RCC_APB2ENR_DFSDM2EN_bit			25
#define RCC_APB2ENR_DFSDM1EN_bit			24
...
#define RCC_APB2ENR_UART10EN_bit			7
#define RCC_APB2ENR_UART9EN_bit				6
...
#define RCC_APB2ENR_DFSDM2EN_bb				BITBAND(&RCC->APB2ENR, RCC_APB2ENR_DFSDM2EN_bit)
#define RCC_APB2ENR_DFSDM1EN_bb				BITBAND(&RCC->APB2ENR, RCC_APB2ENR_DFSDM1EN_bit)
...
#define RCC_APB2ENR_UART10EN_bb				BITBAND(&RCC->APB2ENR, RCC_APB2ENR_UART10EN_bit)
#define RCC_APB2ENR_UART9EN_bb				BITBAND(&RCC->APB2ENR, RCC_APB2ENR_UART9EN_bit)
...
#define RCC_APB1LPENR_CAN3LPEN_bit			27
...
#define RCC_APB1LPENR_CAN3LPEN_bb			BITBAND(&RCC->APB1LPENR, RCC_APB1LPENR_CAN3LPEN_bit)
...
#define RCC_APB2LPENR_DFSDM2EN_bit			25
#define RCC_APB2LPENR_DFSDM1EN_bit			24
...
#define RCC_APB2LPENR_EXTITLPEN_bit			15
...
#define RCC_APB2LPENR_UART10LPEN_bit		7
#define RCC_APB2LPENR_UART9LPEN_bit			6
...
#define RCC_APB2LPENR_DFSDM2EN_bb			BITBAND(&RCC->APB2LPENR, RCC_APB2LPENR_DFSDM2EN_bit)
#define RCC_APB2LPENR_DFSDM1EN_bb			BITBAND(&RCC->APB2LPENR, RCC_APB2LPENR_DFSDM1EN_bit)
...
#define RCC_APB2LPENR_EXTITLPEN_bb			BITBAND(&RCC->APB2LPENR, RCC_APB2LPENR_EXTITLPEN_bit)
...
#define RCC_APB2LPENR_UART10LPEN_bb			BITBAND(&RCC->APB2LPENR, RCC_APB2LPENR_UART10LPEN_bit)
#define RCC_APB2LPENR_UART9LPEN_bb			BITBAND(&RCC->APB2LPENR, RCC_APB2LPENR_UART9LPEN_bit)
...
#define RCC_PLLI2SCFGR_PLLI2SSRC_bit		22
...
#define RCC_PLLI2SCFGR_PLLI2SSRC_bb			BITBAND(&RCC->PLLI2SCFGR, RCC_PLLI2SCFGR_PLLI2SSRC_bit)
...
#define RCC_DCKCFGR_CKDFSDM1SEL_bit			31
...
#define RCC_DCKCFGR_CKDFSDM1ASEL_bit		15
#define RCC_DCKCFGR_CKDFSDM2ASEL_bit		14
...
#define RCC_DCKCFGR_PLLDIVR_bit				8
#define RCC_DCKCFGR_PLLDIVR_0_bit			8
#define RCC_DCKCFGR_PLLDIVR_1_bit			9
#define RCC_DCKCFGR_PLLDIVR_2_bit			10
#define RCC_DCKCFGR_PLLDIVR_3_bit			11
#define RCC_DCKCFGR_PLLDIVR_4_bit			12
...
#define RCC_DCKCFGR_PLLI2SDIVR_bit			0
#define RCC_DCKCFGR_PLLI2SDIVR_0_bit		0
#define RCC_DCKCFGR_PLLI2SDIVR_1_bit		1
#define RCC_DCKCFGR_PLLI2SDIVR_2_bit		2
#define RCC_DCKCFGR_PLLI2SDIVR_3_bit		3
#define RCC_DCKCFGR_PLLI2SDIVR_4_bit		4
...
#define RCC_DCKCFGR_CKDFSDM1SEL_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1SEL_bit)
...
#define RCC_DCKCFGR_CKDFSDM1ASEL_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1ASEL_bit)
#define RCC_DCKCFGR_CKDFSDM2ASEL_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM2ASEL_bit)
...
#define RCC_DCKCFGR_PLLDIVR_0_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLLDIVR_0_bit)
#define RCC_DCKCFGR_PLLDIVR_1_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLLDIVR_1_bit)
#define RCC_DCKCFGR_PLLDIVR_2_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLLDIVR_2_bit)
#define RCC_DCKCFGR_PLLDIVR_3_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLLDIVR_3_bit)
#define RCC_DCKCFGR_PLLDIVR_4_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLLDIVR_4_bit)
...
#define RCC_DCKCFGR_PLL2SDIVR_0_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLL2SDIVR_0_bit)
#define RCC_DCKCFGR_PLL2SDIVR_1_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLL2SDIVR_1_bit)
#define RCC_DCKCFGR_PLL2SDIVR_2_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLL2SDIVR_2_bit)
#define RCC_DCKCFGR_PLL2SDIVR_3_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLL2SDIVR_3_bit)
#define RCC_DCKCFGR_PLL2SDIVR_4_bb			BITBAND(&RCC->DCKCFGR, RCC_DCKCFGR_PLL2SDIVR_4_bit)

/*---------------------------------------------------------------------------------------------------------------------+
| RCC_CKGATENR - RCC clocks gated enable register
+---------------------------------------------------------------------------------------------------------------------*/

#define RCC_CKGATENR_EVTCL_CKEN_bit			7
...
#define RCC_CKGATENR_EVTCL_CKEN_bb			BITBAND(&RCC->CKGATENR, RCC_CKGATENR_EVTCL_CKEN_bit)
...
#endif	/* SOURCE_CHIP_STM32_STM32F4_INCLUDE_DISTORTOS_CHIP_STM32F4_RCC_BITS_H_ */
