...
static_assert(DISTORTOS_CHIP_STM32F4_PWR_VOLTAGE_SCALE_MODE == 1, "Over-drive mode requires voltage scale 1 mode!");
...
constexpr uint8_t voltageScaleIndex {DISTORTOS_CHIP_STM32F4_PWR_VOLTAGE_SCALE_MODE - 1};
...
constexpr uint32_t pllInFrequency {DISTORTOS_CHIP_STM32F4_RCC_HSE_FREQUENCY};
#endif

/// VCO input frequency, Hz
constexpr uint32_t vcoInFrequency {pllInFrequency / DISTORTOS_CHIP_STM32F4_RCC_PLLM};
...
constexpr uint32_t vcoOutFrequency {vcoInFrequency * DISTORTOS_CHIP_STM32F4_RCC_PLLN};
...
constexpr uint32_t pllOutFrequency {vcoOutFrequency / DISTORTOS_CHIP_STM32F4_RCC_PLLP};

static_assert(pllOutFrequency <= maxPllOutFrequency, "Invalid PLL output frequency!");

/// PLL "Q" output frequency, Hz
constexpr uint32_t pllqOutFrequency {vcoOutFrequency / DISTORTOS_CHIP_STM32F4_RCC_PLLQ};
...
constexpr uint32_t pllrOutFrequency {vcoOutFrequency / DISTORTOS_CHIP_STM32F4_RCC_PLLR};
...
constexpr uint32_t sysclkFrequency {DISTORTOS_CHIP_STM32F4_RCC_HSE_FREQUENCY};
...
#else	// !def DISTORTOS_CHIP_STM32F4_STANDARD_CLOCK_CONFIGURATION_ENABLE

/// SYSCLK frequency, Hz
constexpr uint32_t sysclkFrequency {DISTORTOS_CHIP_STM32F4_RCC_SYSCLK_FREQUENCY};
...
/// AHB frequency, Hz
constexpr uint32_t ahbFrequency {sysclkFrequency / DISTORTOS_CHIP_STM32F4_RCC_HPRE};

/// APB1 frequency, Hz
constexpr uint32_t apb1Frequency {ahbFrequency / DISTORTOS_CHIP_STM32F4_RCC_PPRE1};

static_assert(apb1Frequency <= maxApb1Frequency, "Invalid APB1 (low speed) frequency!");

/// APB2 frequency, Hz
constexpr uint32_t apb2Frequency {ahbFrequency / DISTORTOS_CHIP_STM32F4_RCC_PPRE2};
