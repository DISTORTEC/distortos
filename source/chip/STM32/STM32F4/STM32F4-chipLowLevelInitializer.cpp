...
{
#ifdef DISTORTOS_CHIP_STM32F4_FLASH_PREFETCH_ENABLE
	static_assert(DISTORTOS_CHIP_STM32F4_VDD_MV >= 2100,
			"Instruction prefetch must not be enabled when supply voltage is below 2.1 V!");
	configureInstructionPrefetch(true);
#else	// !def DISTORTOS_CHIP_STM32F4_FLASH_PREFETCH_ENABLE
	configureInstructionPrefetch(false);
#endif	// !def DISTORTOS_CHIP_STM32F4_FLASH_PREFETCH_ENABLE

#ifdef DISTORTOS_CHIP_STM32F4_FLASH_DATA_CACHE_ENABLE
	enableDataCache();
#else	// !def DISTORTOS_CHIP_STM32F4_FLASH_DATA_CACHE_ENABLE
	disableDataCache();
#endif	// !def DISTORTOS_CHIP_STM32F4_FLASH_DATA_CACHE_ENABLE

#ifdef DISTORTOS_CHIP_STM32F4_FLASH_INSTRUCTION_CACHE_ENABLE
	enableInstructionCache();
#else	// !def DISTORTOS_CHIP_STM32F4_FLASH_INSTRUCTION_CACHE_ENABLE
	disableInstructionCache();
#endif	// !def DISTORTOS_CHIP_STM32F4_FLASH_INSTRUCTION_CACHE_ENABLE

#ifdef DISTORTOS_CHIP_STM32F4_STANDARD_CLOCK_CONFIGURATION_ENABLE

	STM32_BITBAND(RCC, APB1ENR, PWREN) = 1;

	configureVoltageScaling(DISTORTOS_CHIP_STM32F4_PWR_VOLTAGE_SCALE_MODE);
		...
		defined(DISTORTOS_CHIP_STM32F479)) && defined(DISTORTOS_CHIP_STM32F4_PWR_OVER_DRIVE_ENABLE)
...
#ifdef DISTORTOS_CHIP_STM32F4_RCC_HSE_ENABLE

#ifdef DISTORTOS_CHIP_STM32F4_RCC_HSE_CLOCK_BYPASS
	enableHse(true);
#else	// !def DISTORTOS_CHIP_STM32F4_RCC_HSE_CLOCK_BYPASS
	enableHse(false);
#endif	// !def DISTORTOS_CHIP_STM32F4_RCC_HSE_CLOCK_BYPASS

#endif	// def DISTORTOS_CHIP_STM32F4_RCC_HSE_ENABLE

#ifdef DISTORTOS_CHIP_STM32F4_RCC_PLL_ENABLE

#if defined(DISTORTOS_CHIP_STM32F4_RCC_PLLSRC_HSI)
	configurePllClockSource(false);
#elif defined(DISTORTOS_CHIP_STM32F4_RCC_PLLSRC_HSE)
	configurePllClockSource(true);
#endif

	configurePllInputClockDivider(DISTORTOS_CHIP_STM32F4_RCC_PLLM);
	...
	enablePll(DISTORTOS_CHIP_STM32F4_RCC_PLLN, DISTORTOS_CHIP_STM32F4_RCC_PLLP, DISTORTOS_CHIP_STM32F4_RCC_PLLQ,
			DISTORTOS_CHIP_STM32F4_RCC_PLLR);
...
#endif	// def DISTORTOS_CHIP_STM32F4_RCC_PLL_ENABLE

	configureAhbClockDivider(DISTORTOS_CHIP_STM32F4_RCC_HPRE);
	configureApbClockDivider(false, DISTORTOS_CHIP_STM32F4_RCC_PPRE1);
	configureApbClockDivider(true, DISTORTOS_CHIP_STM32F4_RCC_PPRE2);

#if DISTORTOS_CHIP_STM32F4_VDD_MV < 2100
...
#	endif	// !defined(DISTORTOS_CHIP_STM32F401) && !defined(DISTORTOS_CHIP_STM32F410) &&
		// !defined(DISTORTOS_CHIP_STM32F411) && !defined(DISTORTOS_CHIP_STM32F412) &&
		// !defined(DISTORTOS_CHIP_STM32F413) && !defined(DISTORTOS_CHIP_STM32F423)
#elif DISTORTOS_CHIP_STM32F4_VDD_MV < 2400
#	if defined(DISTORTOS_CHIP_STM32F401) || defined(DISTORTOS_CHIP_STM32F410) || defined(DISTORTOS_CHIP_STM32F411) || \
		defined(DISTORTOS_CHIP_STM32F412) || defined(DISTORTOS_CHIP_STM32F413) || defined(DISTORTOS_CHIP_STM32F423)
...
#	endif	// !defined(DISTORTOS_CHIP_STM32F401) && !defined(DISTORTOS_CHIP_STM32F410) &&
		// !defined(DISTORTOS_CHIP_STM32F411) && !defined(DISTORTOS_CHIP_STM32F412) &&
		// !defined(DISTORTOS_CHIP_STM32F413) && !defined(DISTORTOS_CHIP_STM32F423)
#elif DISTORTOS_CHIP_STM32F4_VDD_MV < 2700
...
#if defined(DISTORTOS_CHIP_STM32F4_RCC_SYSCLK_HSI)
	switchSystemClock(SystemClockSource::hsi);
#elif defined(DISTORTOS_CHIP_STM32F4_RCC_SYSCLK_HSE)
	switchSystemClock(SystemClockSource::hse);
#elif defined(DISTORTOS_CHIP_STM32F4_RCC_SYSCLK_PLL)
	switchSystemClock(SystemClockSource::pll);
#elif defined(DISTORTOS_CHIP_STM32F4_RCC_SYSCLK_PLLR)
	switchSystemClock(SystemClockSource::pllr);
#endif	// defined(DISTORTOS_CHIP_STM32F4_RCC_SYSCLK_PLLR)

#endif	// def DISTORTOS_CHIP_STM32F4_STANDARD_CLOCK_CONFIGURATION_ENABLE
...
#ifdef DISTORTOS_CHIP_STM32_GPIO_V2_GPIOJ_ENABLE
			RCC_AHB1ENR_GPIOJEN |
#endif	// def DISTORTOS_CHIP_STM32_GPIO_V2_GPIOJ_ENABLE
#ifdef DISTORTOS_CHIP_STM32_GPIO_V2_GPIOK_ENABLE
			RCC_AHB1ENR_GPIOKEN |
#endif	// def DISTORTOS_CHIP_STM32_GPIO_V2_GPIOK_ENABLE
			0;
}
