...
ifdef CONFIG_CHIP_STM32F4_UNIFY_SRAM1_SRAM2
	SRAM2_UNIFIED := 1
	UNIFIED_RAM_SIZE := $(shell expr '$(CONFIG_CHIP_STM32F4_SRAM1_SIZE)' '+' '$(CONFIG_CHIP_STM32F4_SRAM2_SIZE)')
...
ifdef CONFIG_CHIP_STM32F4_UNIFY_SRAM2_SRAM3
	SRAM2_UNIFIED := 1
	SRAM3_UNIFIED := 1
	SRAM23_SIZE := $(shell expr '$(CONFIG_CHIP_STM32F4_SRAM2_SIZE)' '+' '$(CONFIG_CHIP_STM32F4_SRAM3_SIZE)')
