/**
 * \file
 * \brief Declaration of unique device ID in ST,NUCLEO-G0B1RE (ST,STM32G0B1RE chip)
 *
...
#ifndef SOURCE_BOARD_ST_NUCLEO_G0B1RE_INCLUDE_DISTORTOS_CHIP_UNIQUEDEVICEID_HPP_
#define SOURCE_BOARD_ST_NUCLEO_G0B1RE_INCLUDE_DISTORTOS_CHIP_UNIQUEDEVICEID_HPP_
...
#endif	// SOURCE_BOARD_ST_NUCLEO_G0B1RE_INCLUDE_DISTORTOS_CHIP_UNIQUEDEVICEID_HPP_
