#
# file: Toolchain-ST_NUCLEO-U575ZI-Q.cmake
#
...
if(SOURCE_BOARD_ST_NUCLEO_U575ZI_Q_TOOLCHAIN_ST_NUCLEO_U575ZI_Q_CMAKE_)
	return()
endif()
set(SOURCE_BOARD_ST_NUCLEO_U575ZI_Q_TOOLCHAIN_ST_NUCLEO_U575ZI_Q_CMAKE_ 1)
...
set(CMAKE_C_FLAGS
		"-ffunction-sections -fdata-sections -Wall -Wextra -Wshadow -mcpu=cortex-m33 -mfpu=fpv5-sp-d16 -mthumb"
		CACHE STRING "Flags used by the C compiler during all build types.")
set(CMAKE_CXX_FLAGS
		"-fno-rtti -fno-exceptions -ffunction-sections -fdata-sections -Wall -Wextra -Wshadow -Wno-psabi -mcpu=cortex-m33 -mfpu=fpv5-sp-d16 -mthumb"
...
set(DISTORTOS_BOARD_PATH "source/board/ST_NUCLEO-U575ZI-Q")
