...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_FMPI2C1_EV_ENABLE
	NVIC_SetPriority(FMPI2C1_EV_IRQn, interruptPriority);
	NVIC_EnableIRQ(FMPI2C1_EV_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_FMPI2C1_EV_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_FMPI2C1_ER_ENABLE
	NVIC_SetPriority(FMPI2C1_ER_IRQn, interruptPriority);
	NVIC_EnableIRQ(FMPI2C1_ER_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_FMPI2C1_ER_ENABLE
}
