/**
 * \file
 * \brief ST,NUCLEO-F446RE (ST,STM32F446RE chip) vector table, default handlers and NVIC low-level initializer
 *
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_FMPI2C1_EV_ENABLE
	NVIC_SetPriority(FMPI2C1_EV_IRQn, interruptPriority);
	NVIC_EnableIRQ(FMPI2C1_EV_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_FMPI2C1_EV_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_FMPI2C1_ER_ENABLE
	NVIC_SetPriority(FMPI2C1_ER_IRQn, interruptPriority);
	NVIC_EnableIRQ(FMPI2C1_ER_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_FMPI2C1_ER_ENABLE
}
