...
if(distortos_Peripherals_DMA1)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${DISTORTOS_CHIP_DMA1_CHANNEL0_DEPENDENTS}
			HELP "Enable DMA1 channel 0 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_DMA1_CHANNEL0_ENABLE)

	list(LENGTH DISTORTOS_CHIP_DMA1_CHANNEL0_DEPENDENTS length)
	if(length GREATER 1)
		string(REPLACE ";" ", " dependents "${DISTORTOS_CHIP_DMA1_CHANNEL0_DEPENDENTS}")
...
if(distortos_Peripherals_DMA2)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${DISTORTOS_CHIP_DMA2_CHANNEL0_DEPENDENTS}
			HELP "Enable DMA2 channel 0 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_DMA2_CHANNEL0_ENABLE)

	list(LENGTH DISTORTOS_CHIP_DMA2_CHANNEL0_DEPENDENTS length)
	if(length GREATER 1)
		string(REPLACE ";" ", " dependents "${DISTORTOS_CHIP_DMA2_CHANNEL0_DEPENDENTS}")
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${DISTORTOS_CHIP_DMA2_CHANNEL6_DEPENDENTS}
			HELP "Enable DMA2 channel 6 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_DMA2_CHANNEL6_ENABLE)

	list(LENGTH DISTORTOS_CHIP_DMA2_CHANNEL6_DEPENDENTS length)
	if(length GREATER 1)
		string(REPLACE ";" ", " dependents "${DISTORTOS_CHIP_DMA2_CHANNEL6_DEPENDENTS}")
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${DISTORTOS_CHIP_DMA2_CHANNEL7_DEPENDENTS}
			HELP "Enable DMA2 channel 7 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_DMA2_CHANNEL7_ENABLE)

	list(LENGTH DISTORTOS_CHIP_DMA2_CHANNEL7_DEPENDENTS length)
	if(length GREATER 1)
		string(REPLACE ";" ", " dependents "${DISTORTOS_CHIP_DMA2_CHANNEL7_DEPENDENTS}")
