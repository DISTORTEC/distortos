/**
 * \file
 * \brief Definitions of low-level DMA channel drivers for DMAv1 in ST,NUCLEO-L476RG (ST,STM32L476RG chip)
 *
...
#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_ENABLE
...
#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL1_ENABLE
...
#ifndef DMA2_Channel1_BASE
#error "DMA2 channel 1 not present!"
#endif	// !def DMA2_Channel1_BASE
...
/**
 * \brief DMA2_Channel1 interrupt handler
 */
...
#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL1_ENABLE

#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL2_ENABLE
...
#ifndef DMA2_Channel2_BASE
#error "DMA2 channel 2 not present!"
#endif	// !def DMA2_Channel2_BASE
...
/**
 * \brief DMA2_Channel2 interrupt handler
 */
...
#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL2_ENABLE

#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL3_ENABLE
...
#ifndef DMA2_Channel3_BASE
#error "DMA2 channel 3 not present!"
#endif	// !def DMA2_Channel3_BASE
...
/**
 * \brief DMA2_Channel3 interrupt handler
 */
...
#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL3_ENABLE

#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL4_ENABLE
...
#ifndef DMA2_Channel4_BASE
#error "DMA2 channel 4 not present!"
#endif	// !def DMA2_Channel4_BASE
...
/**
 * \brief DMA2_Channel4 interrupt handler
 */
...
#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL4_ENABLE

#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL5_ENABLE
...
#ifndef DMA2_Channel5_BASE
#error "DMA2 channel 5 not present!"
#endif	// !def DMA2_Channel5_BASE
...
/**
 * \brief DMA2_Channel5 interrupt handler
 */
...
#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL5_ENABLE

#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL6_ENABLE
...
#ifndef DMA2_Channel6_BASE
#error "DMA2 channel 6 not present!"
#endif	// !def DMA2_Channel6_BASE
...
/**
 * \brief DMA2_Channel6 interrupt handler
 */
...
#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL6_ENABLE

#ifdef DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL7_ENABLE
...
#ifndef DMA2_Channel7_BASE
#error "DMA2 channel 7 not present!"
#endif	// !def DMA2_Channel7_BASE
...
/**
 * \brief DMA2_Channel7 interrupt handler
 */
...
#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL7_ENABLE

#endif	// def DISTORTOS_CHIP_STM32_DMAV1_DMA2_ENABLE
