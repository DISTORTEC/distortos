/**
 * \file
 * \brief ST,STM32F0DISCOVERY (ST,STM32F051R8 chip) vector table, default handlers and NVIC low-level initializer
 *
...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA1_CH1_ENABLE
	NVIC_SetPriority(DMA1_Ch1_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Ch1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA1_CH1_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA1_CH2_3_DMA2_CH1_2_ENABLE
	NVIC_SetPriority(DMA1_Ch2_3_DMA2_Ch1_2_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Ch2_3_DMA2_Ch1_2_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA1_CH2_3_DMA2_CH1_2_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA1_CH4_7_DMA2_CH3_5_ENABLE
	NVIC_SetPriority(DMA1_Ch4_7_DMA2_Ch3_5_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Ch4_7_DMA2_Ch3_5_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA1_CH4_7_DMA2_CH3_5_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_USART3_8_ENABLE
	NVIC_SetPriority(USART3_8_IRQn, interruptPriority);
	NVIC_EnableIRQ(USART3_8_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_USART3_8_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_CEC_CAN_ENABLE
	NVIC_SetPriority(CEC_CAN_IRQn, interruptPriority);
	NVIC_EnableIRQ(CEC_CAN_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_CEC_CAN_ENABLE
