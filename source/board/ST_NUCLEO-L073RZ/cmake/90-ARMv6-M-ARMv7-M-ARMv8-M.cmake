...
if(ARCHITECTURE_NVIC_DMA1_CHANNEL4_ENABLE)
	set(ARCHITECTURE_NVIC_DMA1_CHANNEL4_5_6_7_ENABLE ON)
...
if(ARCHITECTURE_NVIC_DMA1_CHANNEL4_5_6_7_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_DMA1_CHANNEL4_5_6_7_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_DMA1_CHANNEL4_5_6_7_ENABLE)
...
if(ARCHITECTURE_NVIC_USART4_ENABLE)
	set(ARCHITECTURE_NVIC_USART4_5_ENABLE ON)
...
if(ARCHITECTURE_NVIC_USART4_5_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_USART4_5_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_USART4_5_ENABLE)
...
if(ARCHITECTURE_NVIC_TIM21_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_TIM21_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_TIM21_ENABLE)

if(ARCHITECTURE_NVIC_I2C3_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_I2C3_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_I2C3_ENABLE)

if(ARCHITECTURE_NVIC_TIM22_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_TIM22_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_TIM22_ENABLE)
...
if(ARCHITECTURE_NVIC_AES_ENABLE)
	set(ARCHITECTURE_NVIC_AES_RNG_LPUART1_ENABLE ON)
...
if(ARCHITECTURE_NVIC_AES_RNG_LPUART1_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_AES_RNG_LPUART1_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_AES_RNG_LPUART1_ENABLE)
