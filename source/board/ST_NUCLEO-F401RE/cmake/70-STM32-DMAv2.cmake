...
distortosSetConfiguration(BOOLEAN
		...
		OFF
		DEPENDENTS ${STM32_DMA_V2_DMA1_DEPENDENTS}
		HELP "Enable DMA1 low-level driver."
		OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_ENABLE)
...
if(distortos_Peripherals_DMA1)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL0_DEPENDENTS}
			HELP "Enable DMA1 channel 0 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL0_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL1_DEPENDENTS}
			HELP "Enable DMA1 channel 1 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL1_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL2_DEPENDENTS}
			HELP "Enable DMA1 channel 2 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL2_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL3_DEPENDENTS}
			HELP "Enable DMA1 channel 3 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL3_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL4_DEPENDENTS}
			HELP "Enable DMA1 channel 4 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL4_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL5_DEPENDENTS}
			HELP "Enable DMA1 channel 5 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL5_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL6_DEPENDENTS}
			HELP "Enable DMA1 channel 6 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL6_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA1_CHANNEL7_DEPENDENTS}
			HELP "Enable DMA1 channel 7 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA1_CHANNEL7_ENABLE)
...
distortosSetConfiguration(BOOLEAN
		...
		OFF
		DEPENDENTS ${STM32_DMA_V2_DMA2_DEPENDENTS}
		HELP "Enable DMA2 low-level driver."
		OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_ENABLE)
...
if(distortos_Peripherals_DMA2)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL0_DEPENDENTS}
			HELP "Enable DMA2 channel 0 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL0_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL1_DEPENDENTS}
			HELP "Enable DMA2 channel 1 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL1_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL2_DEPENDENTS}
			HELP "Enable DMA2 channel 2 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL2_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL3_DEPENDENTS}
			HELP "Enable DMA2 channel 3 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL3_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL4_DEPENDENTS}
			HELP "Enable DMA2 channel 4 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL4_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL5_DEPENDENTS}
			HELP "Enable DMA2 channel 5 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL5_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL6_DEPENDENTS}
			HELP "Enable DMA2 channel 6 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL6_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V2_DMA2_CHANNEL7_DEPENDENTS}
			HELP "Enable DMA2 channel 7 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV2_DMA2_CHANNEL7_ENABLE)
