...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_ENABLE)
...
if(distortos_Peripherals_DMA1)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_CHANNEL1_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_CHANNEL2_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_CHANNEL3_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_CHANNEL4_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_CHANNEL5_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_CHANNEL6_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA1_CHANNEL7_ENABLE)
...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_ENABLE)
...
if(distortos_Peripherals_DMA2)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL1_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL2_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL3_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL4_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL5_ENABLE)
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V1_DMA2_CHANNEL6_DEPENDENTS}
			HELP "Enable DMA2 channel 6 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL6_ENABLE)

	list(LENGTH STM32_DMA_V1_DMA2_CHANNEL6_DEPENDENTS length)
	if(length GREATER 1)
		string(REPLACE ";" ", " dependents "${STM32_DMA_V1_DMA2_CHANNEL6_DEPENDENTS}")
	...
	distortosSetConfiguration(BOOLEAN
			...
			OFF
			DEPENDENTS ${STM32_DMA_V1_DMA2_CHANNEL7_DEPENDENTS}
			HELP "Enable DMA2 channel 7 low-level driver."
			OUTPUT_NAME DISTORTOS_CHIP_STM32_DMAV1_DMA2_CHANNEL7_ENABLE)

	list(LENGTH STM32_DMA_V1_DMA2_CHANNEL7_DEPENDENTS length)
	if(length GREATER 1)
		string(REPLACE ";" ", " dependents "${STM32_DMA_V1_DMA2_CHANNEL7_DEPENDENTS}")
