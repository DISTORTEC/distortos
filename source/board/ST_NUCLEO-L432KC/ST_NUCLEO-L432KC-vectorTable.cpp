...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ADC1_ENABLE
	NVIC_SetPriority(ADC1_IRQn, interruptPriority);
	NVIC_EnableIRQ(ADC1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ADC1_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_ENABLE
	NVIC_SetPriority(TIM1_TRG_COM_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_TRG_COM_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CRS_ENABLE
	NVIC_SetPriority(CRS_IRQn, interruptPriority);
	NVIC_EnableIRQ(CRS_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CRS_ENABLE
