/**
 * \file
 * \brief ST,NUCLEO-L432KC (ST,STM32L432KC chip) vector table, default handlers and NVIC low-level initializer
 *
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_PVD_PVM_ENABLE
	NVIC_SetPriority(PVD_PVM_IRQn, interruptPriority);
	NVIC_EnableIRQ(PVD_PVM_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_PVD_PVM_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL1_ENABLE
	NVIC_SetPriority(DMA1_Channel1_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Channel1_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL1_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL2_ENABLE
	NVIC_SetPriority(DMA1_Channel2_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Channel2_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL2_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL3_ENABLE
	NVIC_SetPriority(DMA1_Channel3_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Channel3_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL3_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL4_ENABLE
	NVIC_SetPriority(DMA1_Channel4_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Channel4_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL4_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL5_ENABLE
	NVIC_SetPriority(DMA1_Channel5_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Channel5_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL5_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL6_ENABLE
	NVIC_SetPriority(DMA1_Channel6_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Channel6_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL6_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL7_ENABLE
	NVIC_SetPriority(DMA1_Channel7_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Channel7_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_CHANNEL7_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ADC1_ENABLE
	NVIC_SetPriority(ADC1_IRQn, interruptPriority);
	NVIC_EnableIRQ(ADC1_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ADC1_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_BRK_TIM15_ENABLE
	NVIC_SetPriority(TIM1_BRK_TIM15_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_BRK_TIM15_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_BRK_TIM15_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_UP_TIM16_ENABLE
	NVIC_SetPriority(TIM1_UP_TIM16_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_UP_TIM16_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_UP_TIM16_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_ENABLE
	NVIC_SetPriority(TIM1_TRG_COM_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_TRG_COM_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL4_ENABLE
	NVIC_SetPriority(DMA2_Channel4_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel4_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL4_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL5_ENABLE
	NVIC_SetPriority(DMA2_Channel5_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel5_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL5_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_COMP_ENABLE
	NVIC_SetPriority(COMP_IRQn, interruptPriority);
	NVIC_EnableIRQ(COMP_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_COMP_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LPTIM2_ENABLE
	NVIC_SetPriority(LPTIM2_IRQn, interruptPriority);
	NVIC_EnableIRQ(LPTIM2_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LPTIM2_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL6_ENABLE
	NVIC_SetPriority(DMA2_Channel6_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel6_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL6_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL7_ENABLE
	NVIC_SetPriority(DMA2_Channel7_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel7_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_CHANNEL7_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LPUART1_ENABLE
	NVIC_SetPriority(LPUART1_IRQn, interruptPriority);
	NVIC_EnableIRQ(LPUART1_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LPUART1_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SWPMI1_ENABLE
	NVIC_SetPriority(SWPMI1_IRQn, interruptPriority);
	NVIC_EnableIRQ(SWPMI1_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SWPMI1_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LCD_ENABLE
	NVIC_SetPriority(LCD_IRQn, interruptPriority);
	NVIC_EnableIRQ(LCD_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LCD_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_AES_ENABLE
	NVIC_SetPriority(AES_IRQn, interruptPriority);
	NVIC_EnableIRQ(AES_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_AES_ENABLE
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_RNG_ENABLE
	NVIC_SetPriority(RNG_IRQn, interruptPriority);
	NVIC_EnableIRQ(RNG_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_RNG_ENABLE
...
#ifdef CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CRS_ENABLE
	NVIC_SetPriority(CRS_IRQn, interruptPriority);
	NVIC_EnableIRQ(CRS_IRQn);
#endif	// def CONFIG_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CRS_ENABLE
...
// ADC1, address 0x88, exception number 34, IRQ number 18
...
// USB, address 0x14c, exception number 83, IRQ number 67
...
// CRS, address 0x188, exception number 98, IRQ number 82
__attribute__ ((weak)) void CRS_IRQHandler()
{
	while (1);
}

// I2C4_EV, address 0x18c, exception number 99, IRQ number 83
__attribute__ ((weak)) void I2C4_EV_IRQHandler()
{
	while (1);
}

// I2C4_ER, address 0x190, exception number 100, IRQ number 84
...
const ExceptionVector vectorTable[] __attribute__ ((section(".vectorTable"), used))
{
		...
		ADC1_IRQHandler,		// ADC1, address 0x88, exception number 34, IRQ number 18
		...
		nullptr,		// Reserved, address 0xb8, exception number 46, IRQ number 30
		...
		nullptr,		// Reserved, address 0xe8, exception number 58, IRQ number 42
		nullptr,		// Reserved, address 0xec, exception number 59, IRQ number 43
		nullptr,		// Reserved, address 0xf0, exception number 60, IRQ number 44
		nullptr,		// Reserved, address 0xf4, exception number 61, IRQ number 45
		nullptr,		// Reserved, address 0xf8, exception number 62, IRQ number 46
		nullptr,		// Reserved, address 0xfc, exception number 63, IRQ number 47
		nullptr,		// Reserved, address 0x100, exception number 64, IRQ number 48
		SDMMC1_IRQHandler,		// SDMMC1, address 0x104, exception number 65, IRQ number 49
		nullptr,		// Reserved, address 0x108, exception number 66, IRQ number 50
		...
		nullptr,		// Reserved, address 0x114, exception number 69, IRQ number 53
		...
		nullptr,		// Reserved, address 0x13c, exception number 79, IRQ number 63
		...
		USB_IRQHandler,		// USB, address 0x14c, exception number 83, IRQ number 67
		...
		nullptr,		// Reserved, address 0x16c, exception number 91, IRQ number 75
		...
		CRS_IRQHandler,		// CRS, address 0x188, exception number 98, IRQ number 82
		I2C4_EV_IRQHandler,		// I2C4_EV, address 0x18c, exception number 99, IRQ number 83
		I2C4_ER_IRQHandler,		// I2C4_ER, address 0x190, exception number 100, IRQ number 84
};
