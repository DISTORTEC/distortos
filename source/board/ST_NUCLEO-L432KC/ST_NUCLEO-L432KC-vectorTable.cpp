...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_TIM1_BRK_TIM15_ENABLE
	NVIC_SetPriority(TIM1_BRK_TIM15_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_BRK_TIM15_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_TIM1_BRK_TIM15_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_TIM1_UP_TIM16_ENABLE
	NVIC_SetPriority(TIM1_UP_TIM16_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_UP_TIM16_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_TIM1_UP_TIM16_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL1_ENABLE
	NVIC_SetPriority(DMA2_Channel1_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL1_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL2_ENABLE
	NVIC_SetPriority(DMA2_Channel2_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel2_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL2_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL3_ENABLE
	NVIC_SetPriority(DMA2_Channel3_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel3_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL3_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL4_ENABLE
	NVIC_SetPriority(DMA2_Channel4_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel4_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL4_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL5_ENABLE
	NVIC_SetPriority(DMA2_Channel5_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel5_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL5_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL6_ENABLE
	NVIC_SetPriority(DMA2_Channel6_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel6_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL6_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL7_ENABLE
	NVIC_SetPriority(DMA2_Channel7_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Channel7_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_DMA2_CHANNEL7_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_SWPMI1_ENABLE
	NVIC_SetPriority(SWPMI1_IRQn, interruptPriority);
	NVIC_EnableIRQ(SWPMI1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_SWPMI1_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_NVIC_AES_ENABLE
	NVIC_SetPriority(AES_IRQn, interruptPriority);
	NVIC_EnableIRQ(AES_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_NVIC_AES_ENABLE
