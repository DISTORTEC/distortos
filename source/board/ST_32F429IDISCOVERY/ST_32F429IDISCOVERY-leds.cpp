...
chip::OutputPin leds[ledsCount]
{
		...
		chip::OutputPin{chip::Pin::pg13, false, chip::PinOutputSpeed::low, chip::PinPull::none, false, false},
#endif	// def DISTORTOS_BOARD_LEDS_LD3_ENABLE
#ifdef DISTORTOS_BOARD_LEDS_LD4_ENABLE
		chip::OutputPin{chip::Pin::pg14, false, chip::PinOutputSpeed::low, chip::PinPull::none, false, false},
