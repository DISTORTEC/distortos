#
# file: Toolchain-ST_32F429IDISCOVERY.cmake
#
...
if(SOURCE_BOARD_ST_32F429IDISCOVERY_TOOLCHAIN_ST_32F429IDISCOVERY_CMAKE_)
	return()
endif()
set(SOURCE_BOARD_ST_32F429IDISCOVERY_TOOLCHAIN_ST_32F429IDISCOVERY_CMAKE_ 1)
...
set(CMAKE_CXX_FLAGS
		"-fno-rtti -fno-exceptions -ffunction-sections -fdata-sections -Wall -Wextra -Wshadow -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mthumb"
		CACHE STRING "Flags used by the CXX compiler during all build types.")
set(CMAKE_EXE_LINKER_FLAGS
		"-Wl,--gc-sections -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mthumb"
...
set(DISTORTOS_BOARD_PATH "source/board/ST_32F429IDISCOVERY")
