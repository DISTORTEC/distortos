...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TAMPER_ENABLE
	NVIC_SetPriority(TAMPER_IRQn, interruptPriority);
	NVIC_EnableIRQ(TAMPER_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TAMPER_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USB_HP_CAN1_TX_ENABLE
	NVIC_SetPriority(USB_HP_CAN1_TX_IRQn, interruptPriority);
	NVIC_EnableIRQ(USB_HP_CAN1_TX_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USB_HP_CAN1_TX_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USB_LP_CAN1_RX0_ENABLE
	NVIC_SetPriority(USB_LP_CAN1_RX0_IRQn, interruptPriority);
	NVIC_EnableIRQ(USB_LP_CAN1_RX0_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USB_LP_CAN1_RX0_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_BRK_ENABLE
	NVIC_SetPriority(TIM1_BRK_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_BRK_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_BRK_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_UP_ENABLE
	NVIC_SetPriority(TIM1_UP_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_UP_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_UP_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USBWAKEUP_ENABLE
	NVIC_SetPriority(USBWakeUp_IRQn, interruptPriority);
	NVIC_EnableIRQ(USBWakeUp_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USBWAKEUP_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM6_ENABLE
	NVIC_SetPriority(TIM6_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM6_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM6_ENABLE
