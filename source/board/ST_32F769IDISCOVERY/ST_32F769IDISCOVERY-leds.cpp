...
chip::OutputPin leds[ledsCount]
{
		...
		chip::OutputPin{chip::Pin::pj13, false, chip::PinOutputSpeed::low, chip::PinPull::none, false, false},
#endif	// def DISTORTOS_BOARD_LEDS_LD1_ENABLE
#ifdef DISTORTOS_BOARD_LEDS_LD2_ENABLE
		chip::OutputPin{chip::Pin::pj5, false, chip::PinOutputSpeed::low, chip::PinPull::none, false, false},
