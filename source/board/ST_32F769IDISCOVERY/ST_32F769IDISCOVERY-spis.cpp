...
{
		spi2Peripheral,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI2_RX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI2_RX_DMA_CHANNEL),
		CONFIG_CHIP_STM32_SPIV2_SPI2_RX_DMA_REQUEST,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI2_TX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI2_TX_DMA_CHANNEL),
...
#ifdef CONFIG_CHIP_STM32_SPIV2_SPI4_DMA_BASED

SpiMasterLowLevelDmaBased spi4
{
		spi4Peripheral,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI4_RX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI4_RX_DMA_CHANNEL),
		CONFIG_CHIP_STM32_SPIV2_SPI4_RX_DMA_REQUEST,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI4_TX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI4_TX_DMA_CHANNEL),
		CONFIG_CHIP_STM32_SPIV2_SPI4_TX_DMA_REQUEST
};

#else	// !def CONFIG_CHIP_STM32_SPIV2_SPI4_DMA_BASED
...
#endif	// !def CONFIG_CHIP_STM32_SPIV2_SPI4_DMA_BASED
...
#ifdef CONFIG_CHIP_STM32_SPIV2_SPI5_DMA_BASED

SpiMasterLowLevelDmaBased spi5
{
		spi5Peripheral,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI5_RX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI5_RX_DMA_CHANNEL),
		CONFIG_CHIP_STM32_SPIV2_SPI5_RX_DMA_REQUEST,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI5_TX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI5_TX_DMA_CHANNEL),
		CONFIG_CHIP_STM32_SPIV2_SPI5_TX_DMA_REQUEST
};

#else	// !def CONFIG_CHIP_STM32_SPIV2_SPI5_DMA_BASED
...
#endif	// !def CONFIG_CHIP_STM32_SPIV2_SPI5_DMA_BASED
...
#ifdef CONFIG_CHIP_STM32_SPIV2_SPI6_DMA_BASED

SpiMasterLowLevelDmaBased spi6
{
		spi6Peripheral,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI6_RX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI6_RX_DMA_CHANNEL),
		CONFIG_CHIP_STM32_SPIV2_SPI6_RX_DMA_REQUEST,
		DMA_CHANNEL(CONFIG_CHIP_STM32_SPIV2_SPI6_TX_DMA, CONFIG_CHIP_STM32_SPIV2_SPI6_TX_DMA_CHANNEL),
		CONFIG_CHIP_STM32_SPIV2_SPI6_TX_DMA_REQUEST
};

#else	// !def CONFIG_CHIP_STM32_SPIV2_SPI6_DMA_BASED
...
#endif	// !def CONFIG_CHIP_STM32_SPIV2_SPI6_DMA_BASED
