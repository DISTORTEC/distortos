...
distortosSetFixedConfiguration(BOOLEAN
		DISTORTOS_ARCHITECTURE_ARM_CORTEX_M7
		ON)

distortosSetFixedConfiguration(BOOLEAN
		DISTORTOS_ARCHITECTURE_ARM_CORTEX_M7_R1P0
		ON)
...
distortosSetConfiguration(STRING
		...
		OUTPUT_NAME DISTORTOS_LD_ITCM_DATA_LMA_REGION
		OUTPUT_TYPES BOOLEAN)
...
if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TAMP_STAMP_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TAMP_STAMP_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TAMP_STAMP_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_RTC_WKUP_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_RTC_WKUP_ENABLE
			ON)
...
if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_TIM11_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_TIM11_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_TIM11_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_CC_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_CC_ENABLE
			ON)
...
if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CEC_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CEC_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CEC_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_EV_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_EV_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_EV_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_ER_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_ER_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_ER_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPDIF_RX_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPDIF_RX_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPDIF_RX_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DSI_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DSI_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DSI_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT0_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT0_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT0_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT1_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT1_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT1_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT2_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT2_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT2_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT3_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT3_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DFSDM1_FLT3_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SDMMC2_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SDMMC2_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SDMMC2_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_TX_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_TX_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_TX_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX0_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX0_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX0_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX1_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX1_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX1_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_SCE_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_SCE_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_SCE_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_JPEG_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_JPEG_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_JPEG_ENABLE)

if(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_MDIOS_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_MDIOS_ENABLE
			ON)
endif(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_MDIOS_ENABLE)
