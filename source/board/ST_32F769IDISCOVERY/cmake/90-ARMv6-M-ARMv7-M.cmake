...
if(ARCHITECTURE_NVIC_UART7_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_UART7_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_UART7_ENABLE)

if(ARCHITECTURE_NVIC_UART8_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_UART8_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_UART8_ENABLE)
...
if(ARCHITECTURE_NVIC_SPI5_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_SPI5_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_SPI5_ENABLE)

if(ARCHITECTURE_NVIC_SPI6_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_SPI6_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_SPI6_ENABLE)
...
if(ARCHITECTURE_NVIC_LTDC_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_LTDC_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_LTDC_ENABLE)

if(ARCHITECTURE_NVIC_LTDC_ER_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_LTDC_ER_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_LTDC_ER_ENABLE)
...
if(ARCHITECTURE_NVIC_SPDIF_RX_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_SPDIF_RX_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_SPDIF_RX_ENABLE)

if(ARCHITECTURE_NVIC_DSI_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_DSI_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_DSI_ENABLE)
...
if(ARCHITECTURE_NVIC_CAN3_TX_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_CAN3_TX_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_CAN3_TX_ENABLE)

if(ARCHITECTURE_NVIC_CAN3_RX0_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_CAN3_RX0_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_CAN3_RX0_ENABLE)

if(ARCHITECTURE_NVIC_CAN3_RX1_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_CAN3_RX1_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_CAN3_RX1_ENABLE)

if(ARCHITECTURE_NVIC_CAN3_SCE_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_CAN3_SCE_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_CAN3_SCE_ENABLE)

if(ARCHITECTURE_NVIC_JPEG_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_JPEG_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_JPEG_ENABLE)

if(ARCHITECTURE_NVIC_MDIOS_ENABLE)
	distortosSetFixedConfiguration(BOOLEAN
			DISTORTOS_ARCHITECTURE_NVIC_MDIOS_ENABLE
			ON)
endif(ARCHITECTURE_NVIC_MDIOS_ENABLE)
