...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32_SDMMCV1_SDMMC1_ENABLE)
...
if(distortos_Peripherals_SDMMC1)
	...
	distortosSetFixedConfiguration(INTEGER
			DISTORTOS_CHIP_STM32_SDMMCV1_SDMMC1_DMA
			"${CMAKE_MATCH_1}")
	distortosSetFixedConfiguration(INTEGER
			DISTORTOS_CHIP_STM32_SDMMCV1_SDMMC1_DMA_CHANNEL
			"${CMAKE_MATCH_2}")
	distortosSetFixedConfiguration(INTEGER
...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME DISTORTOS_CHIP_STM32_SDMMCV1_SDMMC2_ENABLE)
...
if(distortos_Peripherals_SDMMC2)
	...
	string(REGEX MATCH
			...
			"${distortos_Peripherals_SDMMC2_00_DMA}")
	distortosSetFixedConfiguration(INTEGER
			DISTORTOS_CHIP_STM32_SDMMCV1_SDMMC2_DMA
			"${CMAKE_MATCH_1}")
	distortosSetFixedConfiguration(INTEGER
			DISTORTOS_CHIP_STM32_SDMMCV1_SDMMC2_DMA_CHANNEL
			"${CMAKE_MATCH_2}")
	distortosSetFixedConfiguration(INTEGER
			DISTORTOS_CHIP_STM32_SDMMCV1_SDMMC2_DMA_REQUEST
			"${CMAKE_MATCH_3}")
	list(APPEND STM32_DMA_V2_DMA${CMAKE_MATCH_1}_DEPENDENTS "SDMMC2")
	list(APPEND STM32_DMA_V2_DMA${CMAKE_MATCH_1}_CHANNEL${CMAKE_MATCH_2}_DEPENDENTS "SDMMC2")

	set(ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SDMMC2_ENABLE ON)
