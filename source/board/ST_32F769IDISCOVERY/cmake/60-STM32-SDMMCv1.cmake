...
distortosSetConfiguration(BOOLEAN
		...
		OUTPUT_NAME CONFIG_CHIP_STM32_SDMMCV1_SDMMC2_ENABLE)
...
if(distortos_Peripherals_SDMMC2)
	...
	string(REGEX MATCH
			...
			"${distortos_Peripherals_SDMMC2_00_DMA}")
	distortosSetFixedConfiguration(INTEGER
			CONFIG_CHIP_STM32_SDMMCV1_SDMMC2_DMA
			"${CMAKE_MATCH_1}")
	distortosSetFixedConfiguration(INTEGER
			CONFIG_CHIP_STM32_SDMMCV1_SDMMC2_DMA_CHANNEL
			"${CMAKE_MATCH_2}")
	distortosSetFixedConfiguration(INTEGER
			CONFIG_CHIP_STM32_SDMMCV1_SDMMC2_DMA_REQUEST
			"${CMAKE_MATCH_3}")
