...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_PVD_ENABLE
	NVIC_SetPriority(PVD_IRQn, interruptPriority);
	NVIC_EnableIRQ(PVD_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_PVD_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM0_ENABLE
	NVIC_SetPriority(DMA1_Stream0_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream0_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM0_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM1_ENABLE
	NVIC_SetPriority(DMA1_Stream1_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM1_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM2_ENABLE
	NVIC_SetPriority(DMA1_Stream2_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream2_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM2_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM3_ENABLE
	NVIC_SetPriority(DMA1_Stream3_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream3_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM3_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM4_ENABLE
	NVIC_SetPriority(DMA1_Stream4_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream4_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM4_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM5_ENABLE
	NVIC_SetPriority(DMA1_Stream5_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream5_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM5_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM6_ENABLE
	NVIC_SetPriority(DMA1_Stream6_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream6_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM6_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ADC_ENABLE
	NVIC_SetPriority(ADC_IRQn, interruptPriority);
	NVIC_EnableIRQ(ADC_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ADC_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_BRK_TIM9_ENABLE
	NVIC_SetPriority(TIM1_BRK_TIM9_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_BRK_TIM9_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_BRK_TIM9_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_UP_TIM10_ENABLE
	NVIC_SetPriority(TIM1_UP_TIM10_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_UP_TIM10_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_UP_TIM10_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_TIM11_ENABLE
	NVIC_SetPriority(TIM1_TRG_COM_TIM11_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM1_TRG_COM_TIM11_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM1_TRG_COM_TIM11_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_FS_WKUP_ENABLE
	NVIC_SetPriority(OTG_FS_WKUP_IRQn, interruptPriority);
	NVIC_EnableIRQ(OTG_FS_WKUP_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_FS_WKUP_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM8_BRK_TIM12_ENABLE
	NVIC_SetPriority(TIM8_BRK_TIM12_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM8_BRK_TIM12_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM8_BRK_TIM12_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM8_UP_TIM13_ENABLE
	NVIC_SetPriority(TIM8_UP_TIM13_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM8_UP_TIM13_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM8_UP_TIM13_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM8_TRG_COM_TIM14_ENABLE
	NVIC_SetPriority(TIM8_TRG_COM_TIM14_IRQn, interruptPriority);
	NVIC_EnableIRQ(TIM8_TRG_COM_TIM14_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_TIM8_TRG_COM_TIM14_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM7_ENABLE
	NVIC_SetPriority(DMA1_Stream7_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA1_Stream7_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA1_STREAM7_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM0_ENABLE
	NVIC_SetPriority(DMA2_Stream0_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream0_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM0_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM1_ENABLE
	NVIC_SetPriority(DMA2_Stream1_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM1_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM2_ENABLE
	NVIC_SetPriority(DMA2_Stream2_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream2_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM2_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM3_ENABLE
	NVIC_SetPriority(DMA2_Stream3_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream3_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM3_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM4_ENABLE
	NVIC_SetPriority(DMA2_Stream4_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream4_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM4_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ETH_ENABLE
	NVIC_SetPriority(ETH_IRQn, interruptPriority);
	NVIC_EnableIRQ(ETH_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ETH_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ETH_WKUP_ENABLE
	NVIC_SetPriority(ETH_WKUP_IRQn, interruptPriority);
	NVIC_EnableIRQ(ETH_WKUP_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_ETH_WKUP_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_TX_ENABLE
	NVIC_SetPriority(CAN2_TX_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN2_TX_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_TX_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_RX0_ENABLE
	NVIC_SetPriority(CAN2_RX0_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN2_RX0_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_RX0_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_RX1_ENABLE
	NVIC_SetPriority(CAN2_RX1_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN2_RX1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_RX1_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_SCE_ENABLE
	NVIC_SetPriority(CAN2_SCE_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN2_SCE_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN2_SCE_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM5_ENABLE
	NVIC_SetPriority(DMA2_Stream5_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream5_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM5_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM6_ENABLE
	NVIC_SetPriority(DMA2_Stream6_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream6_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM6_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM7_ENABLE
	NVIC_SetPriority(DMA2_Stream7_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2_Stream7_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2_STREAM7_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USART6_ENABLE
	NVIC_SetPriority(USART6_IRQn, interruptPriority);
	NVIC_EnableIRQ(USART6_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_USART6_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_EP1_OUT_ENABLE
	NVIC_SetPriority(OTG_HS_EP1_OUT_IRQn, interruptPriority);
	NVIC_EnableIRQ(OTG_HS_EP1_OUT_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_EP1_OUT_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_EP1_IN_ENABLE
	NVIC_SetPriority(OTG_HS_EP1_IN_IRQn, interruptPriority);
	NVIC_EnableIRQ(OTG_HS_EP1_IN_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_EP1_IN_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_WKUP_ENABLE
	NVIC_SetPriority(OTG_HS_WKUP_IRQn, interruptPriority);
	NVIC_EnableIRQ(OTG_HS_WKUP_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_WKUP_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_ENABLE
	NVIC_SetPriority(OTG_HS_IRQn, interruptPriority);
	NVIC_EnableIRQ(OTG_HS_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_OTG_HS_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DCMI_ENABLE
	NVIC_SetPriority(DCMI_IRQn, interruptPriority);
	NVIC_EnableIRQ(DCMI_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DCMI_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CRYP_ENABLE
	NVIC_SetPriority(CRYP_IRQn, interruptPriority);
	NVIC_EnableIRQ(CRYP_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CRYP_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_HASH_RNG_ENABLE
	NVIC_SetPriority(HASH_RNG_IRQn, interruptPriority);
	NVIC_EnableIRQ(HASH_RNG_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_HASH_RNG_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_UART7_ENABLE
	NVIC_SetPriority(UART7_IRQn, interruptPriority);
	NVIC_EnableIRQ(UART7_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_UART7_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_UART8_ENABLE
	NVIC_SetPriority(UART8_IRQn, interruptPriority);
	NVIC_EnableIRQ(UART8_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_UART8_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPI4_ENABLE
	NVIC_SetPriority(SPI4_IRQn, interruptPriority);
	NVIC_EnableIRQ(SPI4_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPI4_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPI5_ENABLE
	NVIC_SetPriority(SPI5_IRQn, interruptPriority);
	NVIC_EnableIRQ(SPI5_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPI5_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPI6_ENABLE
	NVIC_SetPriority(SPI6_IRQn, interruptPriority);
	NVIC_EnableIRQ(SPI6_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPI6_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LTDC_ENABLE
	NVIC_SetPriority(LTDC_IRQn, interruptPriority);
	NVIC_EnableIRQ(LTDC_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LTDC_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LTDC_ER_ENABLE
	NVIC_SetPriority(LTDC_ER_IRQn, interruptPriority);
	NVIC_EnableIRQ(LTDC_ER_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_LTDC_ER_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2D_ENABLE
	NVIC_SetPriority(DMA2D_IRQn, interruptPriority);
	NVIC_EnableIRQ(DMA2D_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DMA2D_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CEC_ENABLE
	NVIC_SetPriority(CEC_IRQn, interruptPriority);
	NVIC_EnableIRQ(CEC_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CEC_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_EV_ENABLE
	NVIC_SetPriority(I2C4_EV_IRQn, interruptPriority);
	NVIC_EnableIRQ(I2C4_EV_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_EV_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_ER_ENABLE
	NVIC_SetPriority(I2C4_ER_IRQn, interruptPriority);
	NVIC_EnableIRQ(I2C4_ER_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_I2C4_ER_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPDIF_RX_ENABLE
	NVIC_SetPriority(SPDIF_RX_IRQn, interruptPriority);
	NVIC_EnableIRQ(SPDIF_RX_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SPDIF_RX_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DSI_ENABLE
	NVIC_SetPriority(DSI_IRQn, interruptPriority);
	NVIC_EnableIRQ(DSI_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_DSI_ENABLE
...
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SDMMC2_ENABLE
	NVIC_SetPriority(SDMMC2_IRQn, interruptPriority);
	NVIC_EnableIRQ(SDMMC2_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_SDMMC2_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_TX_ENABLE
	NVIC_SetPriority(CAN3_TX_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN3_TX_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_TX_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX0_ENABLE
	NVIC_SetPriority(CAN3_RX0_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN3_RX0_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX0_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX1_ENABLE
	NVIC_SetPriority(CAN3_RX1_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN3_RX1_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_RX1_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_SCE_ENABLE
	NVIC_SetPriority(CAN3_SCE_IRQn, interruptPriority);
	NVIC_EnableIRQ(CAN3_SCE_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_CAN3_SCE_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_JPEG_ENABLE
	NVIC_SetPriority(JPEG_IRQn, interruptPriority);
	NVIC_EnableIRQ(JPEG_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_JPEG_ENABLE
#ifdef DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_MDIOS_ENABLE
	NVIC_SetPriority(MDIOS_IRQn, interruptPriority);
	NVIC_EnableIRQ(MDIOS_IRQn);
#endif	// def DISTORTOS_ARCHITECTURE_ARMV6_M_ARMV7_M_NVIC_MDIOS_ENABLE
}
