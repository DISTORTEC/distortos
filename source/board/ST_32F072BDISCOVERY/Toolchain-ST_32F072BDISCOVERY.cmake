#
# file: Toolchain-ST_32F072BDISCOVERY.cmake
#
...
if(SOURCE_BOARD_ST_32F072BDISCOVERY_TOOLCHAIN_ST_32F072BDISCOVERY_CMAKE_)
	return()
endif()
set(SOURCE_BOARD_ST_32F072BDISCOVERY_TOOLCHAIN_ST_32F072BDISCOVERY_CMAKE_ 1)
...
set(CMAKE_CXX_FLAGS
		"-fno-rtti -fno-exceptions -ffunction-sections -fdata-sections -Wall -Wextra -Wshadow -Wno-psabi -mcpu=cortex-m0 -march=armv6s-m -mthumb"
...
if(DISTORTOS_CONFIGURATION_VERSION LESS 3)
	...
	distortosRemoveFlag(CMAKE_EXE_LINKER_FLAGS "-march")
...
set(DISTORTOS_BOARD_PATH "source/board/ST_32F072BDISCOVERY")
