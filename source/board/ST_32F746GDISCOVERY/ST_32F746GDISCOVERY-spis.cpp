/**
 * \file
 * \brief Definitions of low-level SPI master drivers for SPIv2 in ST,32F746GDISCOVERY (ST,STM32F746NG chip)
 *
...
{
		spi1Peripheral,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI1_RX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI1_RX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI1_RX_DMA_REQUEST,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI1_TX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI1_TX_DMA_CHANNEL),
...
{
		spi2Peripheral,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI2_RX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI2_RX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI2_RX_DMA_REQUEST,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI2_TX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI2_TX_DMA_CHANNEL),
...
{
		spi3Peripheral,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI3_RX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI3_RX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI3_RX_DMA_REQUEST,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI3_TX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI3_TX_DMA_CHANNEL),
...
#ifdef DISTORTOS_CHIP_STM32_SPIV2_SPI4_ENABLE
...
#ifdef DISTORTOS_CHIP_STM32_SPIV2_SPI4_DMA_BASED

SpiMasterLowLevelDmaBased spi4
{
		spi4Peripheral,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI4_RX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI4_RX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI4_RX_DMA_REQUEST,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI4_TX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI4_TX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI4_TX_DMA_REQUEST
};

#else	// !def DISTORTOS_CHIP_STM32_SPIV2_SPI4_DMA_BASED
...
#endif	// !def DISTORTOS_CHIP_STM32_SPIV2_SPI4_DMA_BASED

#endif	// def DISTORTOS_CHIP_STM32_SPIV2_SPI4_ENABLE

#ifdef DISTORTOS_CHIP_STM32_SPIV2_SPI5_ENABLE
...
#ifdef DISTORTOS_CHIP_STM32_SPIV2_SPI5_DMA_BASED

SpiMasterLowLevelDmaBased spi5
{
		spi5Peripheral,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI5_RX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI5_RX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI5_RX_DMA_REQUEST,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI5_TX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI5_TX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI5_TX_DMA_REQUEST
};

#else	// !def DISTORTOS_CHIP_STM32_SPIV2_SPI5_DMA_BASED
...
#endif	// !def DISTORTOS_CHIP_STM32_SPIV2_SPI5_DMA_BASED

#endif	// def DISTORTOS_CHIP_STM32_SPIV2_SPI5_ENABLE

#ifdef DISTORTOS_CHIP_STM32_SPIV2_SPI6_ENABLE
...
#ifdef DISTORTOS_CHIP_STM32_SPIV2_SPI6_DMA_BASED

SpiMasterLowLevelDmaBased spi6
{
		spi6Peripheral,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI6_RX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI6_RX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI6_RX_DMA_REQUEST,
		DMA_CHANNEL(DISTORTOS_CHIP_STM32_SPIV2_SPI6_TX_DMA, DISTORTOS_CHIP_STM32_SPIV2_SPI6_TX_DMA_CHANNEL),
		DISTORTOS_CHIP_STM32_SPIV2_SPI6_TX_DMA_REQUEST
};

#else	// !def DISTORTOS_CHIP_STM32_SPIV2_SPI6_DMA_BASED
...
#endif	// !def DISTORTOS_CHIP_STM32_SPIV2_SPI6_DMA_BASED

#endif	// def DISTORTOS_CHIP_STM32_SPIV2_SPI6_ENABLE
