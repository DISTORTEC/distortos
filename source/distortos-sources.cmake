...
if(DEFINED DISTORTOS_BLOCKDEVICE_BUFFER_ALIGNMENTS)
	distortosMax(DISTORTOS_BLOCKDEVICE_BUFFER_ALIGNMENT ${DISTORTOS_BLOCKDEVICE_BUFFER_ALIGNMENTS})
	distortosSetFixedConfiguration(INTEGER
...
endif(DEFINED DISTORTOS_BLOCKDEVICE_BUFFER_ALIGNMENTS)

if(DEFINED DISTORTOS_MEMORYTECHNOLOGYDEVICE_BUFFER_ALIGNMENTS)
	distortosMax(DISTORTOS_MEMORYTECHNOLOGYDEVICE_BUFFER_ALIGNMENT ${DISTORTOS_MEMORYTECHNOLOGYDEVICE_BUFFER_ALIGNMENTS})
	distortosSetFixedConfiguration(INTEGER
			CONFIG_MEMORYTECHNOLOGYDEVICE_BUFFER_ALIGNMENT
			${DISTORTOS_MEMORYTECHNOLOGYDEVICE_BUFFER_ALIGNMENT})
endif(DEFINED DISTORTOS_MEMORYTECHNOLOGYDEVICE_BUFFER_ALIGNMENTS)
